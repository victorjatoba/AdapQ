...
public class ItemParamPriorBeta implements ItemParamPrior {
	...
	public double logDensityDeriv1(double p) {
		// Outside limits of distribution density does not change, so derivative
		// is zero
		if (zeroDensity(p))
			return 0.0;
	...
	/**
	 * Second derivative of log density. Only compute part of the log of the
	 * density that depends on the parameter.
	 *
	 * @param p
	 * @return
	 */

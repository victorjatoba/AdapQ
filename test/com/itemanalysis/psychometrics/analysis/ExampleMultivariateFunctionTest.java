...
public class ExampleMultivariateFunctionTest {
	/*
	 * @Test public void numericalGradientTest1() {
	 * System.out.println("Exaple gradient test 1"); ExampleMultivariateFunction
	 * function = new ExampleMultivariateFunction( 1);
	 * 
	 * double[] x = { 5.0, 8.0 };
	 * 
	 ...
	 * }
	 * 
	 * @Test public void numericalGradientTest2() {
	 * System.out.println("Exaple gradient test 2"); ExampleMultivariateFunction
	 * function = new ExampleMultivariateFunction( 2);
	 * 
	 * double[] x = { 5.0, 8.0 };
	 * 
	 * double[] grad = function.gradient(x);
	 * 
	 * double[] exact = new double[2]; exact[0] = -400 * x[0] * (x[1] - x[0] *
	 * x[0]) - 2 * (1 - x[0]); // derivative // of // rosen() // with // respect
	 * // to x exact[1] = 200 * (x[1] - x[0] * x[0]);
	 * 
